                                        ...
                                        <div class="card-body">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body text-right align-self-bottom mt-3">
                                                    <span class="d-block mb-1 font-medium-1">Active Students</span>
                                                    <h1 class="info mb-0">
                                                        {{ $data['students'] }}
                                                    </h1>
                                                </div>
                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            <div class="media d-flex">
                                                ...
                                                <div class="media-body text-right align-self-bottom mt-3">
                                                    <span class="d-block mb-1 font-medium-1">Active Plans</span>
                                                    <h1 class="info mb-0">
                                                       {{ $data['plans'] }}
                                                    </h1>
                                                </div>
                            ...
                            <a href="{{route('admin.boatOwners.index',['type'=>'active'])}}">
                                <div class="card">
                                    <div class="card-content">
                                        ...
                                        </div>   Route::get('/customer-detail', [CustomerController::class, 'detail'])->name('customer-detail');
