    ...
    border-color: #000000 !important;
        ...
        <!-- <div class="card px-0 pt-4 pb-0 mt-3 mb-3"> -->
             ...
             @csrf
                ...
                <!-- <ul id="progressbar" style="display: flex; justify-content: center;">
                    ...
                    <li class='active' id="confirm"><strong style="float: right;  margin-right: -8%;">Slot Booking</strong></li>
                </ul> -->
                
                <!-- fieldsets -->
                <!-- <fieldset> -->
                    <!-- <div class="row ">
                    <div class="form-card col-lg-8 offset-md-2">
      ...
      <div class="container">
        ...
        <div class="col-lg-6  mt-5 mb-login">
                    ...
                    <div class="row">
                        <div class="col-lg-8 mb-4"><p style="font-family: 'Inter';font-style: normal;font-weight: 400;font-size: 16px;line-height: 150%;">Select number of slots</p></div>
                            <div class="col-lg-4">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" style="    margin-left: 8px;" for="flexRadioDefault1">
                                xxxx xxxx xxx24
                                </label>
                            </div>
                        </div>
                        <div class="col-lg-4">
                        <button  id="btn_add_card" style="background: #FFFFFF;border: 1px solid #1C1C1C;box-shadow: 0px 2px 20px rgba(0, 0, 0, 0.07);border-radius: 6px;display: block;width: 100%;border-radius: 6px;color: #1C1C1C;font-size: 14px;font-family: 'Inter', sans-serif;padding: 11px 4px;" type="submit" class="login-m registerBtn"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add another card</button>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                        <button style="background: #FFFFFF;border: 1px solid #1C1C1C;box-shadow: 0px 2px 20px rgba(0, 0, 0, 0.07);border-radius: 6px;display: block;width: 100%;border-radius: 6px;color: #1C1C1C;font-size: 14px;font-family: 'Inter', sans-serif;padding: 11px 4px;" type="submit" class="login-m registerBtn"><i class="fa fa-minus" aria-hidden="true"></i>&nbsp; Remove this card</button>
                        </div>
                    </div>
...
color: #686868;">You have opted for 2 additional slots (£50 per slot)</p>
                        </div>
                    </div>
                    <button type="submit" class="login-m registerBtn">Book Slots</button>
</br>
                    <button style="background: #FFFFFF;border: 1px solid #1C1C1C;box-shadow: 0px 2px 20px rgba(0, 0, 0, 0.07);border-radius: 6px;display: block;width: 100%;border-radius: 6px;color: #1C1C1C;font-size: 18px;line-height: 27px;font-family: 'Inter', sans-serif;padding: 14px 20px;" type="submit" class="login-m registerBtn"><i class="fa fa-paypal" aria-hidden="true"></i>&nbsp; Pay with Paypal</button>
                    </br>
                </form>
            </div>
